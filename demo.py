...
# 加载第一张图片，并获取人脸编码
image_1 = face_recognition.load_image_file("/Users/huanyan/PycharmProjects/IOT/IOT/faces/1.jpg")  # 替换为第一张图片的路径
face_encodings_1 = face_recognition.face_encodings(image_1)

# 加载第二张图片，并获取人脸编码
image_2 = face_recognition.load_image_file("/Users/huanyan/PycharmProjects/IOT/IOT/verify/1.jpg")  # 替换为第二张图片的路径
